...
function getTheme({ theme, name }) {
    ...
    return {
        ...
        colors: {
            ...
            "widget.border": color.widget.border,
            "widget.shadow": color.widget.shadow,
            "selection.background": color.background.selection,
            ...
            "textLink.foreground": color.foreground.link,
            "textLink.activeForeground": color.foreground.link,

            "button.background": color.widget.button,
            "button.foreground": color.foreground.default,
            "button.border": color.hidden,
            "button.separator": "#666666",
            "button.hoverBackground": color.widget.hover,
            "button.secondaryForeground": color.foreground.default,
            "button.secondaryBackground": color.widget.button,
            "button.secondaryHoverBackground": color.widget.hover,
            "checkbox.background": color.widget.input,
            "checkbox.foreground": color.foreground.default,
            "checkbox.border": color.hidden,

            "dropdown.background": color.widget.input,
            "dropdown.foreground": color.foreground.default,
            "dropdown.border": color.hidden,
            "dropdown.listBackground": color.widget.input,

            "input.background": color.widget.input,
            "input.border": color.hidden,
            "input.foreground": color.foreground.default,
            "input.placeholderForeground": color.foreground.muted,
            "inputOption.activeBackground": color.background.selection,
            ...
            "editorIndentGuide.activeBackground1": "#ffffff50",
            "editorIndentGuide.activeBackground2": "#ffffff50",
            "editorIndentGuide.activeBackground3": "#ffffff50",
            "editorIndentGuide.activeBackground4": "#ffffff50",
            "editorIndentGuide.activeBackground5": "#ffffff50",
            "editorIndentGuide.activeBackground6": "#ffffff50",
            "editorIndentGuide.background1": "#ffffff30",
            "editorIndentGuide.background2": "#ffffff30",
            "editorIndentGuide.background3": "#ffffff30",
            "editorIndentGuide.background4": "#ffffff30",
            "editorIndentGuide.background5": "#ffffff30",
            "editorIndentGuide.background6": "#ffffff30",
            ...
            "editor.inactiveSelectionBackground": color.background.selection,
            "editor.selectionBackground": color.background.selection,
            ...
            "minimap.selectionHighlight": color.background.selection,
            ...
            "terminal.selectionBackground": color.background.selection,
