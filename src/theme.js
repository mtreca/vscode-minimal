...
function getTheme({ theme, name }) {
  ...
  return {
    ...
    colors: {
      ...
      focusBorder          : color.border.active, // TODO: Maybe enable with a flag
      ...
      "tab.border"                  : color.border.hidden,
      "tab.unfocusedActiveBorderTop": color.border.hidden,
      "tab.activeBorder"            : color.border.hidden,
      "tab.unfocusedActiveBorder"   : color.border.hidden,
      "tab.activeBorderTop"         : color.border.active,
      ...
      "editorCursor.foreground"           : color.fg.default,
      ...
      'terminal.ansiBrightBlack': color.ansi.black,
      'terminal.ansiBrightRed': color.ansi.red,
      'terminal.ansiBrightGreen': color.ansi.green,
      'terminal.ansiBrightYellow': color.ansi.yellow,
      'terminal.ansiBrightBlue': color.ansi.blue,
      'terminal.ansiBrightMagenta': color.ansi.magenta,
      'terminal.ansiBrightCyan': color.ansi.cyan,
      'terminal.ansiBrightWhite': color.ansi.white,
