...
function getTheme({ theme, name }) {
    ...
    return {
        ...
        colors: {
            ...
            "editorMultiCursor.primary.background": color.background,
            "editorMultiCursor.primary.foreground": alpha(color.blue, 0.75),
            "editorMultiCursor.secondary.background": color.background,
            "editorMultiCursor.secondary.foreground": color.foreground,
            "editor.placeholder.foreground": color.comment,
            ...
            "editor.wordHighlightTextBackground": color.hidden,
            "editor.wordHighlightTextBorder": color.hidden,
            ...
            "editorBracketMatch.border": alpha(color.foreground, 0.5),
            ...
            "editorBracketPairGuide.activeBackground1": color.hidden,
            "editorBracketPairGuide.activeBackground2": color.hidden,
            "editorBracketPairGuide.activeBackground3": color.hidden,
            "editorBracketPairGuide.activeBackground4": color.hidden,
            "editorBracketPairGuide.activeBackground5": color.hidden,
            "editorBracketPairGuide.activeBackground6": color.hidden,
            "editorBracketPairGuide.background1": color.hidden,
            "editorBracketPairGuide.background2": color.hidden,
            "editorBracketPairGuide.background3": color.hidden,
            "editorBracketPairGuide.background4": color.hidden,
            "editorBracketPairGuide.background5": color.hidden,
            "editorBracketPairGuide.background6": color.hidden,
            ...
            "editorHint.border": color.hidden,
            "editorHint.foreground": color.comment,
            "problemsErrorIcon.foreground": color.red,
            "problemsWarningIcon.foreground": color.yellow,
            "problemsInfoIcon.foreground": color.blue,
            ...
            "statusBar.noFolderForeground": color.foreground,
            ...
            "statusBarItem.hoverForeground": color.foreground,
            "statusBarItem.hoverBackground": color.hover,
            "statusBarItem.compactHoverBackground": color.hover,
            "statusBarItem.remoteBackground": color.selection,
            "statusBarItem.remoteForeground": color.foreground,
            "statusBarItem.remoteHoverBackground": alpha(color.selection, 0.75),
            "statusBarItem.remoteHoverForeground": color.foreground,
            "statusBarItem.prominentBackground": color.blue,
            "statusBarItem.prominentForeground": color.foreground,
            "statusBarItem.prominentHoverForeground": alpha(color.blue, 0.75),
            "statusBarItem.prominentHoverBackground": color.hover,
            "statusBarItem.errorBackground": color.red,
            "statusBarItem.errorForeground": color.foreground,
            "statusBarItem.errorHoverBackground": alpha(color.red, 0.75),
            "statusBarItem.errorHoverForeground": color.foreground,
            "statusBarItem.warningBackground": color.yellow,
            "statusBarItem.warningForeground": color.foreground,
            "statusBarItem.warningHoverBackground": alpha(color.yellow, 0.75),
            "statusBarItem.warningHoverForeground": color.foreground,
            "statusBarItem.offlineBackground": color.magenta,
            "statusBarItem.offlineForeground": color.foreground,
            "statusBarItem.offlineHoverForeground": color.foreground,
            "statusBarItem.offlineHoverBackground": alpha(color.magenta, 0.75),
